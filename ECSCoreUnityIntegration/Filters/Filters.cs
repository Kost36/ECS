        ...
        public override void TryAdd(Component component, Entity entity)
        {
            ...
            if (type == typeof(T0))
            {
                if (entity.Get(out T1 componentT1))
                {
                    ...
                    return;
                } //Если есть второй компонент у сущности
            } //Если тип совпадает
            if (type == typeof(T1))
            {
            ...
            if (type == typeof(T0))
            {
                if (entity.Get(out T1 componentT1))
                {
                    if (entity.Get(out T2 componentT2))
                    {
                        ...
                        return;
                    } //Если есть третий компонент у сущности
                } //Если есть второй компонент у сущности
            } //Если тип совпадает
            if (type == typeof(T1))
            {
                ...
                if (entity.Get(out T1 componentT1))
                {
                    if (entity.Get(out T2 componentT2))
                    {
                        if (entity.Get(out T3 componentT3))
                        {
                            ...
                            return;
                        } //Если есть четвертый компонент у сущности
                    } //Если есть третий компонент у сущности
                } //Если есть второй компонент у сущности
            } //Если тип совпадает
            if (type == typeof(T1))
                    ...
                    if (entity.Get(out T2 componentT2))
                    {
                        if (entity.Get(out T3 componentT3))
                        {
                            if (entity.Get(out T4 componentT4))
                            {
                                ...
                                return;
                            } //Если есть пятый компонент у сущности
                        } //Если есть четвертый компонент у сущности
                    } //Если есть третий компонент у сущности
                } //Если есть второй компонент у сущности
            } //Если тип совпадает
                    ...
                    if (entity.Get(out T2 componentT2))
                    {
                        if (entity.Get(out T3 componentT3))
                        {
                            if (entity.Get(out T4 componentT4))
                            {
                                Remove(entity.Id);
                                return;
                            } //Если есть компонент у сущности
                        } //Если есть четвертый компонент у сущности
                    } //Если есть третий компонент у сущности
                } //Если есть второй компонент у сущности
            } //Если тип совпадает
